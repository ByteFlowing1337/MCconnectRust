...
function App() {
  ...
  useEffect(() => {
    invoke<string>("get_steam_name").then(setSteamName).catch(console.error);
  ...
  return (
    <div className="min-h-screen w-screen bg-transparent flex flex-col">
      <div className="flex-1 bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white font-sans selection:bg-blue-500/30 rounded-xl border border-white/10 shadow-2xl flex flex-col relative m-2 min-h-0">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1614728853913-1e22ba0e982b?q=80&w=2574&auto=format&fit=crop')] bg-cover bg-center opacity-20 pointer-events-none rounded-xl" />
