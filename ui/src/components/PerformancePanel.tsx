    ...
    >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="space-y-1.5">
            <div className="text-white text-base font-mono font-semibold">
              {metrics.send_rate_mbps.toFixed(2)}{" "}
              <span className="text-xs text-white/60 font-normal">MB/s</span>
            </div>
            <div className="text-white/70 text-xs font-mono">
              {metrics.send_rate_pps.toFixed(0)}{" "}
              <span className="text-white/50">pkt/s</span>
            </div>
        ...
        >
          ...
          <div className="space-y-1.5">
            <div className="text-white text-base font-mono font-semibold">
              {metrics.recv_rate_mbps.toFixed(2)}{" "}
              <span className="text-xs text-white/60 font-normal">MB/s</span>
            </div>
            <div className="text-white/70 text-xs font-mono">
              {metrics.recv_rate_pps.toFixed(0)}{" "}
              <span className="text-white/50">pkt/s</span>
            </div>
            <div className="text-white/50 text-xs pt-1">
        ...
        <div>
          ...
          <div className="h-2 bg-white/5 rounded-full overflow-hidden shadow-inner">
            <div
              ...
              style={{
                width: `${Math.min((metrics.send_rate_mbps / 10) * 100, 100)}%`,
              }}
            />
          </div>
        </div>
        <div>
          ...
          <div className="h-2 bg-white/5 rounded-full overflow-hidden shadow-inner">
            <div
              ...
              style={{
                width: `${Math.min((metrics.recv_rate_mbps / 10) * 100, 100)}%`,
              }}
            />
          </div>
        </div>
